...
Route::get('/music/artist', [MusicController::class, 'getArtistList'])->name('music.artist.index');
Route::get('/music/artist/{artist}', [MusicController::class, 'showArtist'])->name('music.artist.show');
Route::get('/music/track', [MusicController::class, 'getTrackList'])->name('music.track.index');
...
Route::prefix('music')->group(function () {
    Route::get('collection', [MusicController::class, 'getCollectionList'])->name('music.collection.index');
    Route::get('collection/{collection}', [MusicController::class, 'showCollection'])->name('music.collection.show');
});
